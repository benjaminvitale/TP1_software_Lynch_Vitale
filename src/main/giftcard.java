// GiftCard: mismas ideas que Cart/CreditCard (constantes + asserts)
package gc.domain;
...
public final class GiftCard {
  ...
  public GiftCard charge(Merchant merchant, BigDecimal amount, String description, Instant when) {
    assertClaimed();
    ...
    movements.add(Movement.debit(when, merchant.id(), norm, description));
    return this;
  }
